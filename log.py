...
def plotTicTacToe(log_path):
    ...
    for i in range(len(data)): #append all dataf
...
model_name = {"tictactoe":"", "snake":"", "spaceinvader":"", "connectfour":""}
# If you want to plot your last training, change those variables
plot_last = {"tictactoe":False, "snake":False, "spaceinvader":False, "connectfour":False}


plot_functions = {"tictactoe": plotTicTacToe, "snake": plotSnake, "spaceinvader":plotSpaceInvader, "connectfour": plotConnectFour}
for i in model_name:
    path = model_name[i]
    if path != "":
